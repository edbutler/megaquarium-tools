...
pub const TANK_PATHS: &[&str] = &["Data/tanks.data", "DLC/Freshwater Frenzy/Data/ff tanks.data"];
...
pub const FIXTURE_PATHS: &[&str] = &[
    "Data/scenery.data",
    "Data/equipment.data",
    "DLC/Freshwater Frenzy/Data/ff scenery.data",
    "DLC/Freshwater Frenzy/Data/ff equipment.data",
];
