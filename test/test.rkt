...
;
;(define basic-tnktyp 'name (tnktyp (cons 2 2) (cons 6 6) 2 #f))
;(define rounded-tnktyp 'name (tnktyp (cons 2 2) (cons 6 6) 2 #t))
;(define tank-warm-100 (make-tank 1 #:type basic-tnktyp #:size 100 #:environment warm-env #:lighting 0))
;(define tank-cold-100 (make-tank 2 #:type basic-tnktyp #:size 100 #:environment cold-env #:lighting 0))
;(define tank-warm-20  (make-tank 3 #:type basic-tnktyp #:size  20 #:environment warm-env #:lighting 0))
;(define tank-cold-20  (make-tank 4 #:type basic-tnktyp #:size  20 #:environment cold-env #:lighting 0))
;
...
;
;  (define tank-warm-35 (make-tank 1 #:type basic-tnktyp #:size 35 #:environment warm-env))
;  (define tank-warm-36 (make-tank 2 #:type basic-tnktyp #:size 36 #:environment warm-env))
;
...
;
;  (define square-tank (make-tank 1 #:type   basic-tnktyp #:size 100 #:environment warm-env))
;  (define round-tank  (make-tank 2 #:type rounded-tnktyp #:size 100 #:environment warm-env))
;
...
;  (define normies (make-fishes normie 7))
;
;  (define bright-tank (make-tank 1 #:type basic-tnktyp #:size 100 #:environment warm-env #:lighting 1))
;  (define dark-tank   (make-tank 2 #:type basic-tnktyp #:size 100 #:environment warm-env #:lighting 0))
;
...
;  (define normies (make-fishes normie 7))
;
;  (define bright-tank (make-tank 1 #:type basic-tnktyp #:size 100 #:environment warm-env #:lighting 10))
;  (define dim-tank    (make-tank 1 #:type basic-tnktyp #:size 100 #:environment warm-env #:lighting 9))
;  (define dark-tank   (make-tank 2 #:type basic-tnktyp #:size 100 #:environment warm-env #:lighting 0))
;
